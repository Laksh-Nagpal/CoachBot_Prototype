...
class GymCodeWidget extends StatefulWidget {
  const GymCodeWidget({Key key}) : super(key: key);
...
class _GymCodeWidgetState extends State<GymCodeWidget> {
  TextEditingController gymCodController;
              ...
              children: [
                Expanded(
                  child: Padding(
                    ...
                    child: Text(
                      'We will verify you are at a gym affiliated with CoachBot, please enter the gym code associated with your gym below.',
